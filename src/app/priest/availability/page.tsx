...
import { updateMyAvailability } from "@/app/priest/actions";
...
export default async function PriestAvailabilityPage() {
  ...
  return (
    <div>
      ...
      <div className="mt-6 max-w-xl rounded-2xl border border-saffron-100 bg-white p-5 text-sm text-foreground/60 shadow-sm">

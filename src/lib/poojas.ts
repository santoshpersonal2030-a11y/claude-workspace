...
export const poojas: Pooja[] = [
  ...
  },
  {
    ...
    name: "Mahashivratri Puja",
    sanskritName: "महाशिवरात्रि पूजा",
    emoji: "🕉️",
    category: "Festival",
    ritualType: "Abhishek",
    shortDescription:
      "Night-long worship of Lord Shiva with Rudrabhishek on Mahashivratri.",
    durationHours: 2,
    startingPrice: 2500,
    longDescription:
      "Observed on the great night of Shiva, this puja centres on a Rudrabhishek — the ceremonial bathing of the Shiva Lingam with milk, honey, curd and water amid chanting of the Rudram. The Pandit guides the vrat, jaap and the four prahar pujas for health, peace and liberation from afflictions.",
    includes: [
      "Sankalp and Shiva avahan",
      "Rudrabhishek with panchamrit",
      "Bilva-patra archana and Shiva jaap",
      "Aarti and prasad",
  ...
  },
  {
    ...
    sanskritName: "राम नवमी पूजा",
    emoji: "🏹",
    category: "Festival",
    ritualType: "Pooja",
    shortDescription:
      "Celebrate the birth of Lord Rama with puja and Ramayana path.",
    durationHours: 2,
    startingPrice: 2100,
    longDescription:
      "Worship of Lord Rama on his birth tithi, with Ram Janma sankalp, puja of the Ram Parivar and recitation from the Ramcharitmanas / Sunderkand. Performed for dharma, righteousness and harmony in the home.",
    includes: [
      "Ram Parivar avahan and puja",
      "Ram Janma and Ramayana path",
      "Hawan and aarti",
      "Prasad distribution",
      "Verified Pandit at your home",
    ],
  ...
  },
  {
    ...
    sanskritName: "करवा चौथ पूजा",
    emoji: "🌙",
    category: "Festival",
    ritualType: "Katha",
    shortDescription:
      "Pandit-guided Karwa Chauth vrat, katha and moon-sighting puja.",
    durationHours: 1.5,
    startingPrice: 1800,
    longDescription:
      "The fasting wives' festival for the long life and well-being of their husbands. The Pandit conducts the Karwa Chauth katha, the sankalp for the nirjala vrat, the thali/karwa puja and guides the moon-sighting (chandra darshan) and arghya in the evening.",
    includes: [
      "Karwa Chauth vrat sankalp",
      "Karwa Chauth katha recital",
      "Thali and karwa puja",
      "Chandra darshan and arghya guidance",
      "Verified Pandit at your home",
    ],
    requiresMuhurat: false,
  },
  {
    ...
    sanskritName: "गोवर्धन पूजा",
    emoji: "🐄",
    category: "Festival",
    ritualType: "Pooja",
    shortDescription:
      "Annakut offering and Govardhan worship the day after Diwali.",
    durationHours: 1.5,
    startingPrice: 2100,
    longDescription:
      "Performed the day after Diwali, Govardhan Puja honours Lord Krishna's lifting of Govardhan hill. The Pandit conducts the puja of the Govardhan form and the Annakut offering of food, seeking abundance, cattle wealth and protection for the household.",
    includes: [
      "Govardhan and Krishna puja",
      "Annakut offering arrangement",
      "Gau (cow) puja sankalp",
      "Aarti and prasad",
      "Verified Pandit at your home",
    ],
    requiresMuhurat: false,
  },
  {
    ...
    ritualType: "Pooja",
    shortDescription:
      "Pandit-guided Surya and Chhathi Maiya worship with arghya.",
    durationHours: 2,
    startingPrice: 2500,
    longDescription:
      "The four-day festival dedicated to Surya Dev and Chhathi Maiya, observed for the well-being and prosperity of the family. The Pandit guides the rigorous vrat, the sandhya and usha arghya at the water's edge, and the puja vidhi across the days.",
    includes: [
      "Chhath vrat sankalp and vidhi",
      "Sandhya arghya (evening offering)",
      "Usha arghya (sunrise offering)",
      "Surya and Chhathi Maiya puja",
      "Verified Pandit at the ghat / home",
    ],
    requiresMuhurat: false,
  },
  {
    slug: "holika-dahan",
    name: "Holika Dahan",
    sanskritName: "होलिका दहन",
    emoji: "🔥",
    category: "Festival",
    ritualType: "Pooja",
    shortDescription:
      "Holika bonfire puja on the eve of Holi for protection from evil.",
    durationHours: 1,
    startingPrice: 1500,
    longDescription:
      "The bonfire on the eve of Holi marks the triumph of devotion over evil, recalling Prahlad and Holika. The Pandit performs the Holika puja and sankalp before the lighting, with parikrama and offerings for the family's protection and prosperity.",
    includes: [
      "Holika puja and sankalp",
      "Offerings to the sacred fire",
      "Parikrama guidance",
      "Aarti and prasad",
      "Verified Pandit on site",
    ],
    requiresMuhurat: true,
  },
  {

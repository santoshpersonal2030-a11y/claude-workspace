...
const CAL_FESTIVALS: Record<string, Partial<Record<CalLang, string>>> = {
  ...
  "Hanuman Jayanti": { hi: "हनुमान जयंती", te: "హనుమాన్ జయంతి", ta: "அனுமன் ஜயந்தி", kn: "ಹನುಮ ಜಯಂತಿ", ml: "ഹനുമാൻ ജയന്തി", mr: "हनुमान जयंती" },
  ...
  "Krishna Janmashtami": { hi: "कृष्ण जन्माष्टमी", te: "శ్రీకృష్ణ జన్మాష్టమి", ta: "ஸ்ரீ கிருஷ்ண ஜயந்தி", kn: "ಶ್ರೀ ಕೃಷ್ಣ ಜನ್ಮಾಷ್ಟಮಿ", ml: "ശ്രീകൃഷ്ണ ജന്മാഷ്ടമി", mr: "कृष्ण जन्माष्टमी" },
